...
class ScrollmapWithZoom {
    ...
    get _btnIncreaseHeightDefault() {
        return `<a class="enlargedisplay fa fa-arrow-down scrollmap_icon btn_pos_top_left"></a>`;
    }
    get _btnDecreaseHeightDefault() {
        return `<a class="reducedisplay fa fa-arrow-up scrollmap_icon btn_pos_top_left"></a>`;
    }
