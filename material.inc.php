...
$this->monster_infos = array(
  1 => array(
    ...
    4 => array( 'possible_mutations' => 2,  
                ...
                'descr' => self::_('This monster worth 4 points but can evovle to muted form two times by placing mutagenic monster above and below (1st mutation : 9 points, 2nd : 15 points)')
                )
                ),
  2 => array( 'pts' => 0,
              1 => array(
...
$this->medals_infos = array(
  1 => array( 'name' => clienttranslate('first player with 2 complete big monster'),
              'nametr' => self::_('first player with 2 complete big monster'),
              ...
              'category' => 'random',
              'pts' => 5),
  2 => array( 'name' => clienttranslate('first player with 3 differents crystals'),
              'nametr' => self::_('first player with 3 differents crystals'),
              ...
              'category' => 'random',
              'pts' => 5),
  3 => array( 'name' => clienttranslate('first player with 3 Desert tiles'),
              'nametr' => self::_('first player with 3 Desert tiles'),
              ...
              'category' => 'permanent',
              'pts' => 10),
  4 => array( 'name' => clienttranslate('first player with 6 Ice tiles'),
              'nametr' => self::_('first player with 6 Ice tiles'),
              'name_team' => clienttranslate('first team with 12 Ice tiles. 5 points.'),
              'nametr_team' => self::_('first team with 12 Ice tiles. 5 points'),
              'category' => 'random',
              'pts' => 5),
  5 => array( 'name' => clienttranslate('first player with 5 Lava tiles'),
              'nametr' => self::_('first player with 5 Lava tiles'),
              'name_team' => clienttranslate('first team with 10 Lava tiles. 5 points'),
              'nametr_team' => self::_('first team with 10 Lava tiles'),
              'category' => 'random',
              'pts' => 5),
  6 => array( 'name' => clienttranslate('first player with 4 mutagenic monsters'),
              'nametr' => self::_('first player with 4 mutagenic monsters'),
              'name_team' => clienttranslate('first team with 12 mutagenic monsters. 5 points'),
              'nametr_team' => self::_('first team with 12 mutagenic monsters'),
              'category' => 'random',
              'pts' => 5),
  7 => array( 'name' => clienttranslate('At the end of the game, player with fewest desert and rune monsters'),
              'nametr' => self::_('At the end of the game, player with fewest desert and rune monsters'),
              'name_team' => clienttranslate('At the end of the game, team with fewest desert and rune monsters. 5 points'),
              'nametr_team' => self::_('At the end of the game, team with fewest desert and rune monsters'),
              'category' => 'permanent',
              'pts' => -10),
  8 => array( 'name' => clienttranslate('first player with 5 different tiles'),
              'nametr' => self::_('first player with 5 different tiles'),
              'name_team' => clienttranslate('first team with 7 different tiles. 5 points'),
              'nametr_team' => self::_('first team with 7 different tiles'),
              'category' => 'random',
              'pts' => 5),
  9 => array( 'name' => clienttranslate('first player with 4 Rune monsters'),
              'nametr' => self::_('first player with 4 Rune monsters'),
              'name_team' => clienttranslate('first team with 8 Rune monsters. 5 points'),
              'nametr_team' => self::_('first team with 8 Rune monsters'),
              'category' => 'permanent',
              'pts' => 5),
  10 => array( 'name' => clienttranslate('first player with 4 swamp and or grassland tiles'),
              'nametr' => self::_('first player with 4 swamp and or grassland tiles'),
              'name_team' => clienttranslate('first team with 8 swamp and or grassland tiles. 5 points'),
              'nametr_team' => self::_('first team with 8 swamp and or grassland tiles'),
              'category' => 'random',
              'pts' => 5)
);
