...
$this->monster_infos = array(
  ...
  3 => array('name' => 'Big monster',
              'descr' => self::_('1 point alone but 11 points when bigmonster tail and head are put together to make one Big Monster')),
  4 => array(
    1 => array ('pts' => 3,
  ...
  7 => array('pts' => 0,
              ...
              'descr' => self::_('No points as such but is goal of a medal and count as monsters for penalty medal')),
  8 => array(
    1 => array( 'monsters' => 2,
                'pts' => 0,
                'diamonds' => array(),
              'name' => self::_('Rune monster'),
              'descr' => self::_('2 Runes monsters (count as 2 monsters for the penalty medal count)')),
    2 => array( 'monsters' => 1,
                'pts' => 0,
                'diamonds' => array('GL', 'GR'),
              'name' => self::_('Rune monster'),
              'descr' => self::_('Count as one rune monster for penalty medal. Green diamonds on sides')),
    3 => array( 'monsters' => 1,
                'pts' => 0,
                'diamonds' => array('BTL', 'BTR'),
              'name' => self::_('Rune monster'),
              'descr' => self::_('Count as one rune monster for penalty medal. Blue diamonds on top')),
    4 => array( 'monsters' => 1,
                'pts' => 0,
                'diamonds' => array('BBL', 'BBR'),
              'name' => self::_('Rune monster'),
              'descr' => self::_('Count as one rune monster for penalty medal. Blue diamonds on bottom')),
    5 => array( 'monsters' => 1,
                'pts' => 0,
                'diamonds' => array('RT'),
              'name' => self::_('Rune monster'),
              'descr' => self::_('Count as one rune monster for penalty medal. Red diamonds on top')),
    6 => array( 'monsters' => 1,
                'pts' => 0,
                'diamonds' => array('RB'),
              'name' => self::_('Rune monster'),
              'descr' => self::_('Count as one rune monster for penalty medal. Red diamonds on bottom')),
  ),
);
